...
def reshape_data(data):
    ...
    # Subsystem
    df_subsystems = df[df['Subsystem'] != ''].copy()
    ...
    df_subsystems['Port Column'] = df_subsystems.apply(get_column_name, axis=1)
    pivot_df = df_subsystems.pivot_table(index=['Parent Module', 'Subsystem'],
                                         columns='Port Column',
